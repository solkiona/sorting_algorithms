...
Project done during **ALX SOFTWARE ENGINEERING PROGRAM** aims to learn about sorting algorithms (bubble sort, insertion sort, selection sort, quick sort and so on) and Big O Notation in **C language**.
